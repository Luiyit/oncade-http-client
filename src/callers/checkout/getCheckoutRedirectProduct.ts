...
/**
 * Test script for getting checkout redirect URL for products
 * Run: npx tsx src/callers/checkout/getCheckoutRedirectProduct.ts
 */
async function main() {
  try {
    ...
    const itemId = process.env.ONCADE_PRODUCT_ID || 'test-product-id';
